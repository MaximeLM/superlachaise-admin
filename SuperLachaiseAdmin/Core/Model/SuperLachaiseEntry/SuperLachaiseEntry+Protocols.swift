//
//  SuperLachaiseEntry+Protocols.swift
//  SuperLachaiseAdmin
//
...
extension SuperLachaiseEntry: Identifiable, Deletable, Listable, Syncable {
    ...
    static func list(filter: String) -> (Realm) -> Results<SuperLachaiseEntry> {
        return { realm in
